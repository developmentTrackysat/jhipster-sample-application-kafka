...
@AnalyzeClasses(packagesOf = JhipsterSampleApplicationKafkaApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterSampleApplicationKafkaApp.class), alwaysTrue())
