...
import com.trackysat.kafka.config.KafkaSseConsumer;
import com.trackysat.kafka.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/jhipster-sample-application-kafka-kafka")
public class JhipsterSampleApplicationKafkaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationKafkaKafkaResource.class);
    ...
    public JhipsterSampleApplicationKafkaKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
